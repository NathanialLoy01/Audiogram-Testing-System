...
Fig_W = 950;
Fig_H = 700;
Main_Fig = uifigure('Name', sprintf('Critical Listening Trainer - %s', User_Name), ...
...
% PRACTICE TAB
Practice_Tab = uitab(Tab_Group, 'Title', 'Practice Mode');

uilabel(Practice_Tab, 'Text', 'Practice Mode', ...
...
uilabel(Test_Tab, 'Text', 'Test Mode - Unlock New Levels', ...
